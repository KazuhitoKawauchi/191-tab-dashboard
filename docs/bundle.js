(function(){"use strict";(function(){const h=document.createElement("script");h.src="https://cdn.jsdelivr.net/npm/chart.js",h.onload=y,document.head.appendChild(h);function y(){const s=new Date,f=s.getFullYear(),E=s.getMonth()+1,C=a=>a.toLocaleString(),u=[{担当者名:"佐藤",売上金額:95e4,売上予算:1e6,加工高:5e5,加工高予算:5e5,加工高率:"52.6%",加工高達成率:"100%"},{担当者名:"鈴木",売上金額:64e4,売上予算:8e5,加工高:34e4,加工高予算:4e5,加工高率:"53.1%",加工高達成率:"85%"},{担当者名:"田中",売上金額:115e4,売上予算:12e5,加工高:57e4,加工高予算:6e5,加工高率:"49.6%",加工高達成率:"95%"}],w=a=>{const o=document.createElement("div");o.style.width="100%",o.style.overflowX="auto",o.style.marginTop="6px";const n=document.createElement("table");n.style.width="100%",n.style.borderCollapse="collapse";const l=["担当者名","売上予算","売上金額","加工高予算","加工高","加工高率","加工高達成率"],i=document.createElement("thead"),t=document.createElement("tr");l.forEach(p=>{const r=document.createElement("th");r.innerText=p,r.style.border="1px solid #ccc",r.style.textAlign="center",r.style.padding="6px",r.style.backgroundColor=["加工高予算","加工高","加工高率","加工高達成率"].includes(p)?"#ffcc66":"#3399ff",r.style.color=["加工高予算","加工高","加工高率","加工高達成率"].includes(p)?"#000":"#fff",t.appendChild(r)}),i.appendChild(t),n.appendChild(i);const c=document.createElement("tbody");return a.forEach((p,r)=>{const e=document.createElement("tr"),m=r%2===1;l.forEach(d=>{const b=document.createElement("td"),g=p[d],B=typeof g=="number"?C(g):g;b.innerText=B,b.style.border="1px solid #ccc",b.style.textAlign="center",b.style.padding="6px",b.style.backgroundColor=["加工高予算","加工高","加工高率","加工高達成率"].includes(d)?m?"#ffe0b3":"#fff":m?"#e6f3ff":"#fff",e.appendChild(b)}),c.appendChild(e)}),n.appendChild(c),o.appendChild(n),o},k=(a,o)=>{const n=document.createElement("div");n.className="ym-select",n.style.backgroundColor=o,n.style.padding="6px",n.style.marginBottom="8px";let l="",i="";for(let t=0;t<5;t++){const c=2024+t;l+=`<option value="${c}"${c===f?" selected":""}>${c}年</option>`}for(let t=1;t<=12;t++)i+=`<option value="${t}"${t===E?" selected":""}>${t}月</option>`;return n.innerHTML=`
